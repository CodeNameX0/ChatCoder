                            ...
                            ${currentUser ? `
                                <form class="comment-form" data-doc-id="${doc.id}" style="margin-top: 1rem;">
                                    <div style="display: flex; gap: 0.5rem;">
                                        <input type="text" class="comment-input" placeholder="댓글을 입력하세요..." required style="flex: 1; padding: 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 16px; min-height: 48px; box-sizing: border-box; -webkit-appearance: none; appearance: none; line-height: 1.4;" autocomplete="off" autocorrect="off">
